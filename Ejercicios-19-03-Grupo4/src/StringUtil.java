...
public class StringUtil
{
	...
	//Retorna una cadena indentica a s pero sin espacios a la izquierda ni a la derecha.
	public static String trim(String s)
	{
		return s.trim();
	}

	//Retorna la posición de la n-ésima ocurrencia del caracter c dentro de s, o -1 si s no contiene a c.
